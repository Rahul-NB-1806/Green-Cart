...
const fallbackPlants = [
  ...
  { _id: "7", name: "ZZ Plant", price: 549, category: "indoor", image: "", description: "Nearly indestructible plant with waxy green leaves. Thrives on neglect.", isMedicinal: false, stock: 20, rating: { average: 4.6, count: 89 }, careGuide: { wateringSchedule: 'Every 3-4 weeks', sunlightRequirement: 'Low to bright indirect light', soilType: 'Well-draining potting mix', soilChangeFrequency: 'Every 2 years', temperature: '18-27°C', humidity: '30-50%' } },
  { _id: "8", name: "Jade Plant", price: 449, category: "succulent", image: "", description: "Lucky money plant with thick, oval-shaped leaves. Symbol of prosperity.", isMedicinal: false, stock: 12, rating: { average: 4.4, count: 54 }, careGuide: { wateringSchedule: 'Every 2-3 weeks', sunlightRequirement: 'Bright indirect light', soilType: 'Well-draining succulent mix', soilChangeFrequency: 'Every 2 years', temperature: '18-24°C', humidity: 'Low' } },
  { _id: "9", name: "Spider Plant", price: 349, category: "indoor", image: "", description: "Classic trailing plant with arching green-and-white leaves.", isMedicinal: false, stock: 30, rating: { average: 4.4, count: 72 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Bright indirect light', soilType: 'Well-draining potting mix', soilChangeFrequency: 'Every 12-18 months', temperature: '18-27°C', humidity: '40-60%' } },
  { _id: "10", name: "Hibiscus", price: 449, category: "outdoor", image: "", description: "Tropical beauty with large, showy flowers in vibrant colors.", isMedicinal: false, stock: 16, rating: { average: 4.5, count: 57 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Full sun', soilType: 'Rich, well-draining soil', soilChangeFrequency: 'Every 12 months', temperature: '20-30°C', humidity: '50-70%' } },
  { _id: "11", name: "Echeveria", price: 249, category: "succulent", image: "", description: "Rosette-shaped succulent with plump pastel leaves.", isMedicinal: false, stock: 35, rating: { average: 4.3, count: 41 }, careGuide: { wateringSchedule: 'Every 2-3 weeks', sunlightRequirement: 'Bright indirect light', soilType: 'Well-draining cactus mix', soilChangeFrequency: 'Every 2 years', temperature: '15-25°C', humidity: 'Low' } },
  { _id: "12", name: "Ashwagandha", price: 349, category: "medicinal", image: "", description: "Powerful adaptogenic herb used in Ayurveda for stress reduction and vitality.", isMedicinal: true, stock: 20, rating: { average: 4.5, count: 47 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Full sun to partial shade', soilType: 'Well-draining sandy soil', soilChangeFrequency: 'Every 12 months', temperature: '20-35°C', humidity: '40-50%' }, medicalProperties: { uses: ['Stress relief', 'Energy boost', 'Immunity support'], benefits: 'Reduces stress and anxiety, improves energy and concentration.', partsUsed: 'Root', dosageInfo: 'Powder: 1/2 tsp with warm milk daily.', precautions: 'Avoid if pregnant or with thyroid disorders.' } },
  { _id: "13", name: "Rose Plant", price: 399, category: "flowering", image: "", description: "Classic garden rose with fragrant blooms in red, pink, yellow, and white.", isMedicinal: false, stock: 24, rating: { average: 4.6, count: 93 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Full sun (6+ hours)', soilType: 'Rich, well-draining soil', soilChangeFrequency: 'Every 12 months', temperature: '15-28°C', humidity: '50-60%' } },
  { _id: "14", name: "Bougainvillea", price: 549, category: "outdoor", image: "", description: "Drought-tolerant climber with vibrant papery bracts.", isMedicinal: false, stock: 22, rating: { average: 4.4, count: 63 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Full sun', soilType: 'Well-draining sandy soil', soilChangeFrequency: 'Every 2 years', temperature: '15-30°C', humidity: 'Low' } },
  { _id: "15", name: "Bamboo Palm", price: 749, category: "indoor", image: "", description: "Elegant indoor palm that adds a tropical vibe to any room.", isMedicinal: false, stock: 12, rating: { average: 4.3, count: 41 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Bright indirect light', soilType: 'Moist, well-draining potting mix', soilChangeFrequency: 'Every 2 years', temperature: '18-27°C', humidity: '50-70%' } },
  { _id: "16", name: "Philodendron Brasil", price: 449, category: "indoor", image: "", description: "Heart-shaped leaves with stunning green and lime variegation.", isMedicinal: false, stock: 18, rating: { average: 4.5, count: 48 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Medium indirect light', soilType: 'Well-draining potting mix', soilChangeFrequency: 'Every 12-18 months', temperature: '18-27°C', humidity: '50-70%' } },
  { _id: "17", name: "Rosemary", price: 249, category: "medicinal", image: "", description: "Aromatic culinary herb that improves memory and concentration.", isMedicinal: true, stock: 22, rating: { average: 4.2, count: 48 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Full sun', soilType: 'Well-draining sandy soil', soilChangeFrequency: 'Every 12 months', temperature: '15-27°C', humidity: 'Low' }, medicalProperties: { uses: ['Memory improvement', 'Digestive aid', 'Anti-inflammatory'], benefits: 'Improves memory and concentration, aids digestion.', partsUsed: 'Leaves', dosageInfo: 'Tea: 1 tsp dried leaves steeped 5 min. Culinary: use fresh or dried.', precautions: 'Avoid large amounts during pregnancy.' } },
  { _id: "18", name: "Orchid", price: 999, category: "flowering", image: "", description: "Exotic moth orchid with long-lasting elegant blooms.", isMedicinal: false, stock: 7, rating: { average: 4.7, count: 58 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Bright indirect light', soilType: 'Orchid bark mix', soilChangeFrequency: 'Every 12-18 months', temperature: '18-27°C', humidity: '50-80%' } },
  { _id: "19", name: "Neem Plant", price: 399, category: "medicinal", image: "", description: "Natural antibacterial with powerful mosquito-repelling properties.", isMedicinal: true, stock: 15, rating: { average: 4.6, count: 63 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Full sun', soilType: 'Well-draining loamy soil', soilChangeFrequency: 'Every 12 months', temperature: '20-38°C', humidity: '40-60%' }, medicalProperties: { uses: ['Antibacterial', 'Mosquito repellent', 'Skin health', 'Immune support'], benefits: 'Natural antibacterial, repels mosquitoes, improves skin health.', partsUsed: 'Leaves, oil', dosageInfo: 'Leaf paste for skin. Neem oil diluted for topical use.', precautions: 'Do not consume neem oil internally.' } },
  { _id: "20", name: "String of Pearls", price: 399, category: "succulent", image: "", description: "Unique trailing succulent with bead-like leaves. Creates a stunning waterfall effect.", isMedicinal: false, stock: 14, rating: { average: 4.7, count: 56 }, careGuide: { wateringSchedule: 'Every 2-3 weeks', sunlightRequirement: 'Bright indirect light', soilType: 'Well-draining succulent mix', soilChangeFrequency: 'Every 2 years', temperature: '18-27°C', humidity: 'Low' } },
  { _id: "21", name: "Fiddle Leaf Fig", price: 1299, category: "indoor", image: "", description: "The trendiest houseplant with large, violin-shaped leaves.", isMedicinal: false, stock: 8, rating: { average: 4.1, count: 36 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Bright indirect light', soilType: 'Well-draining potting mix with perlite', soilChangeFrequency: 'Every 12-18 months', temperature: '18-27°C', humidity: '40-60%' } },
  { _id: "22", name: "Money Plant (Pothos)", price: 299, category: "indoor", image: "", description: "An easy-to-grow trailing plant that brings positive energy according to Vastu and Feng Shui.", isMedicinal: false, stock: 40, rating: { average: 4.5, count: 112 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Low to bright indirect light', soilType: 'General potting mix', soilChangeFrequency: 'Every 12-18 months', temperature: '17-30°C', humidity: '40-60%' } },
  { _id: "23", name: "Marigold", price: 149, category: "flowering", image: "", description: "Vibrant orange and yellow flowers that bloom abundantly. Natural pest repellent.", isMedicinal: true, stock: 50, rating: { average: 4.0, count: 29 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Full sun', soilType: 'Well-draining fertile soil', soilChangeFrequency: 'Annual replanting', temperature: '15-35°C', humidity: '40-60%' }, medicalProperties: { uses: ['Skin healing', 'Anti-inflammatory', 'Natural dye'], benefits: 'Promotes wound healing, reduces inflammation.', partsUsed: 'Flowers, leaves', dosageInfo: 'Calendula ointment: apply topically. Tea: 1 tsp dried petals steeped 10 min.', precautions: 'May cause allergic reactions in sensitive individuals.' } },
  { _id: "24", name: "Cactus Mix", price: 199, category: "succulent", image: "", description: "A cute, low-maintenance desert plant that thrives on neglect.", isMedicinal: false, stock: 45, rating: { average: 4.1, count: 34 }, careGuide: { wateringSchedule: 'Every 3-4 weeks', sunlightRequirement: 'Bright direct light', soilType: 'Well-draining cactus mix', soilChangeFrequency: 'Every 3 years', temperature: '15-35°C', humidity: 'Low' } },
  { _id: "25", name: "Boston Fern", price: 399, category: "indoor", image: "", description: "Lush, feathery fern that adds instant greenery. Loves humidity.", isMedicinal: false, stock: 12, rating: { average: 4.2, count: 39 }, careGuide: { wateringSchedule: '2-3 times per week', sunlightRequirement: 'Bright indirect light', soilType: 'Moist, well-draining potting mix', soilChangeFrequency: 'Every 12 months', temperature: '16-24°C', humidity: '60-80%' } },
  { _id: "26", name: "Rubber Plant", price: 649, category: "indoor", image: "", description: "Bold, architectural plant with large glossy burgundy leaves.", isMedicinal: false, stock: 14, rating: { average: 4.3, count: 44 }, careGuide: { wateringSchedule: 'Every 1-2 weeks', sunlightRequirement: 'Bright indirect light', soilType: 'Well-draining potting mix', soilChangeFrequency: 'Every 12-18 months', temperature: '18-27°C', humidity: '40-60%' } },
  { _id: "27", name: "Jasmine (Mogra)", price: 299, category: "outdoor", image: "", description: "Fragrant white flowers that fill your garden with enchanting scent.", isMedicinal: true, stock: 28, rating: { average: 4.6, count: 81 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Full sun to partial shade', soilType: 'Rich, well-draining loamy soil', soilChangeFrequency: 'Every 12 months', temperature: '18-35°C', humidity: '50-70%' }, medicalProperties: { uses: ['Stress relief', 'Aromatherapy', 'Skin health'], benefits: 'Reduces stress and anxiety, promotes restful sleep.', partsUsed: 'Flowers, essential oil', dosageInfo: 'Aromatherapy: 2-3 drops in diffuser. Tea: steep fresh flowers 5 min.', precautions: 'Essential oil must be diluted before topical use.' } },
  { _id: "28", name: "Giloy (Guduchi)", price: 249, category: "medicinal", image: "", description: "Immunity-boosting Ayurvedic creeper known as Amrita — the root of immortality.", isMedicinal: true, stock: 18, rating: { average: 4.4, count: 38 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Full sun to partial shade', soilType: 'Well-draining fertile soil', soilChangeFrequency: 'Every 12 months', temperature: '20-40°C', humidity: '50-70%' }, medicalProperties: { uses: ['Immunity booster', 'Fever management', 'Liver health', 'Anti-inflammatory'], benefits: 'Strengthens immune system, helps manage chronic fever.', partsUsed: 'Stem, leaves', dosageInfo: 'Decoction: boil stem pieces in water for 10 min. Juice: 1-2 tsp daily.', precautions: 'May interact with immunosuppressants. Consult doctor before use.' } },
  { _id: "29", name: "Dahlia", price: 349, category: "flowering", image: "", description: "Show-stopping blooms in a rainbow of colors.", isMedicinal: false, stock: 12, rating: { average: 4.3, count: 35 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Full sun', soilType: 'Rich, well-draining soil', soilChangeFrequency: 'Annual replanting', temperature: '15-28°C', humidity: '40-60%' } },
  { _id: "30", name: "Sunflower", price: 149, category: "flowering", image: "", description: "Cheerful, fast-growing annual with massive golden flower heads.", isMedicinal: false, stock: 50, rating: { average: 4.1, count: 27 }, careGuide: { wateringSchedule: 'Every 1-2 days', sunlightRequirement: 'Full sun', soilType: 'Well-draining fertile soil', soilChangeFrequency: 'Annual replanting', temperature: '18-35°C', humidity: '40-50%' } },
  { _id: "31", name: "Turmeric Plant", price: 299, category: "medicinal", image: "", description: "Golden spice plant with powerful anti-inflammatory and antioxidant properties.", isMedicinal: true, stock: 15, rating: { average: 4.4, count: 33 }, careGuide: { wateringSchedule: 'Every 2-3 days', sunlightRequirement: 'Partial shade to bright indirect light', soilType: 'Rich, moist well-draining soil', soilChangeFrequency: 'Every 12 months at harvest', temperature: '20-35°C', humidity: '60-80%' }, medicalProperties: { uses: ['Anti-inflammatory', 'Digestive health', 'Skin care', 'Joint health'], benefits: 'Reduces inflammation, aids digestion, improves skin complexion.', partsUsed: 'Rhizome (root)', dosageInfo: 'Fresh: grate into curries and teas. Golden milk: 1 tsp turmeric powder with warm milk.', precautions: 'May act as a blood thinner. Avoid in large quantities before surgery or with blood thinners.' } },
];
