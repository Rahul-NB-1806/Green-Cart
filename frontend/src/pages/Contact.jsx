  ...
  return (
    <div className="min-h-screen bg-deep-forest font-body pt-16">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <h1 className="font-display text-5xl text-ivory">Get in Touch</h1>
        <p className="text-stone mt-4">We'd love to hear from you</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <svg className="w-5 h-5 text-emerald mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <div>
                <p className="text-ivory font-medium">Email</p>
                <p className="text-stone text-sm">hello@greencart.com</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <svg className="w-5 h-5 text-emerald mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-stone text-sm">+1 (555) 123-4567</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <svg className="w-5 h-5 text-emerald mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p className="text-ivory font-medium">Address</p>
                <p className="text-stone text-sm">Mumbai, India</p>
              </div>
            </div>
          </div>
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              <label className="block text-stone text-sm mb-2">Message</label>
              <textarea
                rows={4}
            ...
            <button
              type="submit"
              className="w-full bg-emerald hover:bg-emerald-dark text-deep-forest font-medium py-3 rounded-xl transition-all"
            >
              Send Message
            </button>
          </form>
